...
class Token extends Enum
{
    ...
    private const FOR_BEGIN = 47;
    private const FOR_END = 2;
    private const BREAK = 3;
    private const CONTINUE = 4;
    private const CLASS_BEGIN = 5;
    private const CLASS_END = 6;
    private const DO_BEGIN = 7;
    private const DO_END = 8;
    private const FUNCTION_BEGIN = 9;
    private const FUNCTION_END = 10;
    private const VARDEF = 11;
    private const IF_BEGIN = 12;
    private const IF_END = 13;
    private const ELSE = 14;
    private const GOTO = 15;
    private const INLINE_HTML = 16;
    private const INTERFACE_BEGIN = 17;
    private const INTERFACE_END = 18;
    private const NAMESPACE = 19;
    private const NAMESPACE_USE = 20;
    private const RETURN = 21;
    private const SWITCH_BEGIN = 22;
    private const SWITCH_END = 23;
    private const THROW = 24;
    private const TRAIT_BEGIN = 25;
    private const TRAIT_END = 26;
    private const TRY = 27;
    private const CATCH_BEGIN = 28;
    private const CATCH_END = 29;
    private const FINALLY = 30;
    private const WHILE_BEGIN = 31;
    private const WHILE_END = 32;
    private const CASE = 33;
    private const TRAIT_USE = 34;
    private const ASSIGN = 35;
    private const TERNARY = 36; // COND expression
    private const NEW_CLASS = 37;
    private const IN_CLASS_BEGIN = 38;
    private const IN_CLASS_END = 39;
    private const NEW_ARRAY = 40;
    private const APPLY = 41;  // CALL expression
    private const ECHO = 42;
    private const UNSET = 43;
    private const ISSET = 44;
    private const EVAL = 45;
    private const YIELD = 46;
}
